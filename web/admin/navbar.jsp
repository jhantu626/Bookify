...
<div class="container-fluid p-3 bg-light">
	<div class="row">
		...
		<div class="col-md-3">
			...
			<a class="btn btn-primary text-white" data-toggle="modal" data-target="#exampleModalCenter"><i class="fas fa-sign-out-alt"></i>Logout</a>                    
                    </c:if>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="text-center">
              ...
              <a href="../logout" type="button" class="btn btn-primary"><i class="fas fa-sign-out-alt"></i>Logout</a>
          </div>
      </div>
